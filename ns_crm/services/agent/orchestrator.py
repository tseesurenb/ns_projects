...
from ns_crm.models.agent import AgentMessage, AgentSession, MessageRole
from ns_crm.models.tenant import Tenant
from ns_crm.services.agent.tools import ToolRegistry
