...
from ns_crm.core.dependencies import get_current_user, get_tenant_id, require_role
from ns_crm.db.session import get_db
from ns_crm.models.agent import AgentSession, AgentTool
from ns_crm.models.user import User, UserRole
from ns_crm.schemas.agent import (
    AgentChatRequest,
    AgentChatResponse,
...
from ns_crm.services.agent.orchestrator import AgentOrchestrator
